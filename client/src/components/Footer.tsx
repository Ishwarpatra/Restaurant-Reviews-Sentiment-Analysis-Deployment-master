  ...
  return (
    <footer className="app-footer">
      ...
      <div className="footer-links">
        ...
        <a href="https://www.linkedin.com/in/iswar-patra-95650a336/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="footer-link">
          <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
      ...
      <p className="footer-text">
        &copy; {new Date().getFullYear()} Restaurant Sentiment Analyser &middot; Built with{' '}
